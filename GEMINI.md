...
5. **Markdown 导出:** 侧边栏实时生成可直接复制的命理分析报告，包含八字/六字摘要、十神、纳音及地势。
6. **专业术语简介:** 针对十神（食神、伤官等）、纳音（海中金、大海水等）及星座提供 Hover Tooltips，悬浮即可查看专业定义与代表含义。
7. **本地存储:** 自动记忆上次输入的日期（公/农历）、时间、性别及地点选择。
