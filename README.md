...
- **专业排盘布局**：
    ...
    - **流年太岁雷达 (Tai Sui Radar)**：全息扫描年、月、日、时四柱，精准锁定“值、冲、害、破、刑”等流年高危时空关系，并在日柱受冲时自动触发极高危预警。
...
- **专业辅助功能**：
    - **真太阳时自动修正**：内置覆盖全国所有省、市、区县的三级经纬度库（3000+ 记录），支持基于经度偏移与均时差（EOT）的自动校时。支持“全境”城市中心点或具体区县的精准选择。
